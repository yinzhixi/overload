...
<body >		
 	 <%request.setCharacterEncoding("utf-8"); %>
		...
		<div class="ms-title" ref="headerLogo">
	            <img src="${pageContext.request.contextPath}/images/login-img01.gif" style="width: 100%;" alt="">
	    </div>
    ...
    <div id='demo' style="color:red;font-size: 10px" display:none></div>
		...
		<div class="foot_line" style="width:100%;"><img style="width:100%;" src="${pageContext.request.contextPath}/images/login-img02.png" alt=""></div>
