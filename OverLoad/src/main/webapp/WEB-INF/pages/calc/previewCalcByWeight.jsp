  ...
  <div>
    ...
    layui.use(['jquery','form', 'layedit', 'laydate','table'], function(){
          ...
          table.render({
            ...
            elem: '#table'
            ,even: true
            ,url:'/preview/calc/query/byWeight'
            ,cols: [[
            	{type:'numbers',width: 250}
              ,{field:'ton',  title: '吨位',width: 250}
              ,{field:'tonNum', title: '数量（辆）',width: 250}
              ,{field:'percent', title: '比例%',width: 250}
            ]]
          ,page: true    //开启分页  
          });
          ...
          $("#export").click(function(){
        	  window.location = "${contextPath}/preview/calc/query/byWeight/export?startDate="+$("#startDate").val()+"&endDate="+$("#endDate").val()+"&station="+$("#station").val();
          });
    });
