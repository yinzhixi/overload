  ...
  <div>
    ...
    layui.use(['jquery','form', 'layedit', 'laydate','table'], function(){
    	  ...
    	  table.render({
    	    ...
    	    elem: '#table'
            ,even: true
    	    ,url:'/preview/calc/query'
    	    ,cols: [[
    	      {field:'date', title: '日期',width: 250}
    	      ,{field:'vehicleTypeName',  title: '车型',width: 250}
    	      ,{field:'totalNum', title: '车辆总数（辆）',width: 250}
    	      ,{field:'overNum', title: '超限总数（辆）',width: 250}
    	    ]]
    	  ,page: true    //开启分页  
    	  });
