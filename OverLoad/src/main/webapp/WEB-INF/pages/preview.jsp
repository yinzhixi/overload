        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline" >
                 <label class="layui-form-label">起始吨位：</label>
                   <div class="layui-input-inline">
                      <input type="number" id="startWeight" name="startWeight" lay-verify="required|phone" autocomplete="off" class="layui-input">
                   </div>
            </div>
            ...
            <div class="layui-inline" >
                 <label class="layui-form-label">截止吨位：</label>
                   <div class="layui-input-inline">
                      <input type="number" id="endWeight" name="endWeight" lay-verify="required|phone" autocomplete="off" class="layui-input">
                   </div>
            </div>
            ...
            <div class="layui-inline" >
                 <label class="layui-form-label">预检序号：</label>
                   <div class="layui-input-inline">
                      <input type="number" id="previewId" name="previewId" lay-verify="required|phone" autocomplete="off" class="layui-input">
                   </div>
            </div>
            <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width:400px;height:35px">
                        ...
                        <button id="export" lay-event="detail" type="reset" class="layui-btn  layui-btn-normal" type="button" style="width:60px;height:35px" id="export">导出</button>
...
<shiro:hasPermission name="preview:update">
  <a class="layui-btn layui-btn-xs" lay-event="editUser"><cite>修改</cite></a>
</shiro:hasPermission>

<shiro:hasPermission name="preview:del"> 
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
</shiro:hasPermission>

<shiro:hasPermission name="preview:reviewed">
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="reviewedPreview">审核明细</a>
</shiro:hasPermission>
    </script>
    ...
    layui.use(['jquery','form', 'layedit', 'laydate','table'], function(){
       ...
       table.render({
          ...
          elem: '#table1',
          data : tableContent
          ,url:'/preview/showAllByPre?number='+Math.random()
          ,align:'center'
        // ,even: true,
